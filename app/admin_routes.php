...
Route::group(array('prefix' => 'admin-cms', 'namespace' => 'App\Controllers\Admin'), function() {
  ...
  Route::group(array('before' => 'admin'), function() {
	...
	Route::get('general', array('as' => 'admin.general', 'uses' => 'GeneralController@getList'));
    Route::get('general/list', array('as' => 'admin.general.list', 'uses' => 'GeneralController@postList'));
	Route::get('general/edit/{id}', array('as' => 'admin.general.edit', 'uses' => 'GeneralController@getFormEdit'));
	Route::post('general/submit', array('as' => 'admin.general.submit', 'uses' => 'GeneralController@postSubmit'));
	...
	Route::post('client/submit', array('as' => 'admin.client.submit', 'uses' => 'ClientController@postSubmit'));
	...
	Route::post('testimony/submit', array('as' => 'admin.testimony.submit', 'uses' => 'TestimonyController@postSubmit'));
